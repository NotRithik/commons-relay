...
_FAILED = {
    ...
    'INVALID_CONTENT_ADDRESS': 'Kite used a file name where Logos needs the stored file address. No download was attempted. Refresh the saved-file list and choose the matching stored file.',
    'STORAGE_CONTENT_ADDRESS_REQUIRED': 'Kite needs to resolve this file from the saved-file list before asking you to approve the download.',
    'STORED_FILE_NOT_FOUND': 'No stored file has that name or content address. Nothing was downloaded.',
    'STORED_FILE_LABEL_AMBIGUOUS': 'More than one stored file has that name. Choose the exact stored file before downloading.',
