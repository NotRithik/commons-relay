// Adapted from logos-blockchain/logos-execution-zone, revision
// 47eba256479f6f785acbd138834340703cd03401, lez/wallet/src/account_manager.rs.
// Original code is dual MIT/Apache-2.0. This copy changes only the public
// storage() accessor so transaction preparation can persist the hash BEFORE
// broadcast, without modifying the upstream wallet library or modules.
use core::fmt;
